...
func main() {
	...
	_ = event.RegisterHandlers(
		// ***********消息事件***********
		// 群@机器人消息事件		GroupATMessageEventHandler(),
		// C2C消息事件
		C2CMessageEventHandler(),
		// 频道@机器人事件		ChannelATMessageEventHandler(),
	)
...
// ChannelATMessageEventHandler 实现处理 at 消息的回璋?func ChannelATMessageEventHandler() event.ATMessageEventHandler {
...
// GroupATMessageEventHandler 实现处理 at 消息的回璋?func GroupATMessageEventHandler() event.GroupATMessageEventHandler {
...
// C2CFriendEventHandler 实现处理好友关系变更的回璋?func C2CFriendEventHandler() event.C2CFriendEventHandler {
...
// ChannelEventHandler 处理子频道事件func ChannelEventHandler() event.ChannelEventHandler {
